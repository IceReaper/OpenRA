...
namespace OpenRA.Game.TiberianDawn;
...
static class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        if (!AppDomain.CurrentDomain.GetAssemblies().Contains(typeof(TmpTDLoader).Assembly))
            throw new Exception("Assembly loading broken!");

        DefaultProgram.Main("OpenRA", "Tiberian Dawn", "cnc", args);
    }
}
