...
namespace OpenRA
{
	public static class Game
	{
		...
		public static string EngineVersion => GitVersionInformation.SemVer;
		...
		{
			var vendorName = args.GetValue("Game.Vendor", null);
			ProductName = args.GetValue("Game.Product", "OpenRA");
			Platform.InitializeSupportDir(vendorName == null ? ProductName : Path.Combine(vendorName, ProductName));
	...
	public static class CurrentServerSettings
	{
		...
		public static Manifest ServerMod;
	}
}
