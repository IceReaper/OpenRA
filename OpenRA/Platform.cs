...
namespace OpenRA
{
	...
	public static class Platform
	{
		...
		public static void InitializeSupportDir(string supportDir)
		{
			...
			switch (CurrentPlatform)
			{
				...
				{
					modernUserSupportPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), supportDir) + Path.DirectorySeparatorChar;
					legacyUserSupportPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), supportDir) + Path.DirectorySeparatorChar;
					systemSupportPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), supportDir) + Path.DirectorySeparatorChar;
					break;
				}
				...
				case PlatformType.OSX:
				{
					modernUserSupportPath = legacyUserSupportPath = Path.Combine(
						...
						"Library", "Application Support", supportDir) + Path.DirectorySeparatorChar;

					systemSupportPath = $"/Library/Application Support/{supportDir}/";
					break;
				}

				case PlatformType.Linux:
				{
					legacyUserSupportPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), $".{supportDir}") + Path.DirectorySeparatorChar;
					...
					modernUserSupportPath = Path.Combine(xdgConfigHome, supportDir) + Path.DirectorySeparatorChar;
					systemSupportPath = $"/var/games/{supportDir}/";
				...
				default:
				{
					modernUserSupportPath = legacyUserSupportPath =
						Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), $".{supportDir}") + Path.DirectorySeparatorChar;
					systemSupportPath = $"/var/games/{supportDir}/";
					break;
				}
			}
