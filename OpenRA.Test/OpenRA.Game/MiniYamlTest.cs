...
9: # Test
	...
	9.1.3: # Test
";
			var serialized = MiniYaml.FromString(Yaml, "", discardCommentsAndWhitespace: false).WriteToString().ReplaceLineEndings();
			Console.WriteLine();
...
9:
	...
	9.1.3:
";
			var serialized = MiniYaml.FromString(Yaml, "").WriteToString().ReplaceLineEndings();
...
";
			...
			var resultYaml = MiniYaml.Merge(new[] { baseYaml, mergeYaml });
			Assert.That(ResultString, Is.EqualTo(resultYaml.WriteToString().ReplaceLineEndings()));
		}
